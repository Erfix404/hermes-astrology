...
3. **Cross-Checking Mundane & Global Events:**
   - Ingresses, eclipses, and lunar cycles should be cross-referenced against authoritative sources if external news verification is requested:
     - **Ephemeris Verification:** [Astrodienst Astro.com](https://www.astro.com) or [Astro-Seek Ephemeris Tables](https://horoscopes.astro-seek.com)
     - **Mundane Canon:** Nicholas Campion (*The Book of World Horoscopes*), Bonatti/Lilly (*Liber Astronomiae*), and Skyscript Ingresses archive.
