...
| # | موج | تمرکز | وضعیت |
|---|-----|-------|-------|
| ۰ | اصلاحات فوری | باگ‌ها + بدهی audit قبلی + شادبالا ۶/۶ | ✅ تمام‌شده |
| ۱ | پیشگویی غربی ⭐ | profections, firdaria, تفسیر ترانزیت, پراگرسیون, ZR والنس | ✅ تمام‌شده |
| ۲ | ودیک پیشگویانه | پراتیانتارداشا, گوچارا با سده‌ساتی, تفسیر داشا, چارا داشا جیمینی | ✅ تمام‌شده |
| ۳ | Mundane / رویداد جهانی | ingress پایتخت‌ها با اعتبار زمانی پویا, خسوف و کسوف, چرخه‌های ماه | ✅ تمام‌شده |
| ۴ | سینستری و روابط | لوت‌های روابط ابن‌عزرا, انطباق خانه‌ها, تفسیر کامپوزیت | ✅ تمام‌شده |
| ۵ | فارسی‌سازی دانش | واژه‌نامه تخصصی, رفرنس‌های تفسیری فارسی, دیکشنری استعاره‌ها | ✅ تمام‌شده |
| ۶ | اعتبارسنجی + انتشار v3.0 | چارت‌های رتبه AA آسترودیتابانک (یونگ، انیشتین، استیو جابز), ریلیز v3.0 | ✅ تمام‌شده |
